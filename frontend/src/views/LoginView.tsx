...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex flex-col justify-between relative overflow-hidden bg-[#131313] text-[#e2e2e2]">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* Abstract grid lines */}
        <div
          className="absolute inset-0 border-t border-l border-[#1E1E1E] opacity-20"
          style={{
      ...
      <main className="flex-grow flex items-center justify-center relative z-10 px-4 md:px-10 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Login Card */}
          <div className="bg-[#121212] border border-[#1E1E1E] rounded-xl p-8 shadow-2xl transition-all duration-300 relative focus-within:border-[#E21E26]/60 focus-within:shadow-[0_0_24px_rgba(226,30,38,0.2)]">
            <form onSubmit={handleSubmit} className="space-y-6" id="rag-login-form">
              {errorMessage && (
                <div className="bg-[#93000a]/20 border border-[#ffb4ab]/40 text-[#ffb4ab] text-xs p-3 rounded">
                  {errorMessage}
                </div>
              )}
              ...
              <div className="space-y-2">
                <label
                  htmlFor="email"
                  className="font-mono-code text-xs text-[#e7bdb8] block uppercase tracking-wider"
                >
                  Institutional Email
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 rounded-lg bg-black border border-[#2D2D2D] text-[#e2e2e2] placeholder-[#555555] font-sans text-base focus:border-[#E21E26] focus:ring-1 focus:ring-[#E21E26] focus:outline-none transition-colors caret-[#E21E26]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs text-[#E21E26] hover:text-white transition-colors underline-offset-4 hover:underline"
                  >
                    Recover Access
                  </button>
                </div>
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center cursor-pointer select-none">
                  <input
                    ...
                    className="h-4 w-4 rounded border-[#2D2D2D] bg-black text-[#E21E26] accent-[#E21E26] focus:ring-[#E21E26]"
                  />
                  <span className="ml-2.5 block text-sm text-[#A3A3A3] font-sans">
                    Maintain Session
                  </span>
                </label>
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-[#E21E26] hover:bg-[#c00017] text-white font-heading font-semibold text-lg py-3 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-[#E21E26] transition-all flex items-center justify-center gap-2 group cursor-pointer disabled:opacity-75"
                >
          ...
          {/* Security Notice */}
          <div className="mt-8 text-center flex items-center justify-center gap-2 text-[#777777] font-mono-code text-xs">
